...
Set fat at **0.7–0.9 g per kg of bodyweight** (never under 0.5 g/kg) to support
hormones, then fill the rest with carbs — your main training fuel, and the one
macro you move when calories need to change.

```
protein_kcal = protein_g × 4
fat_kcal     = fat_g × 9        (fat_g = 0.7–0.9 × kg)
