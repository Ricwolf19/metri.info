...
Pon la grasa en **0.7–0.9 g por kg de peso** (nunca menos de 0.5 g/kg) para apoyar
las hormonas, y rellena el resto con carbohidratos — tu principal combustible de
entrenamiento, y el único macro que mueves cuando las calorías deben cambiar.

```
kcal_proteína = proteína_g × 4
kcal_grasa    = grasa_g × 9      (grasa_g = 0.7–0.9 × kg)
