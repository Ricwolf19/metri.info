    ...
    <section className="py-16 sm:py-24">
      <Container>
        <div className="relative overflow-hidden rounded-card border border-ink-600 bg-ink-800 px-8 py-16 text-center">
          <div
            aria-hidden
            className="glow-brand pointer-events-none absolute inset-x-0 top-0 h-48"
          />
          ...
          <a
            ...
            className="relative mt-8 inline-flex h-12 items-center gap-2 rounded-field bg-ink-50 px-6 font-semibold text-ink-900 transition-transform hover:scale-[1.02]"
          >
            <GithubIcon size={18} />
            {t("oss.cta")}
          </a>
