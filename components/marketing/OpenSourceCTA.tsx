    ...
    <section className="py-20 sm:py-28">
      <Container>
        <div className="relative overflow-hidden rounded-card border border-ink-600 bg-ink-800 px-8 py-16 text-center">
          <div
            aria-hidden
            className="pointer-events-none absolute -top-24 left-1/2 h-64 w-96 -translate-x-1/2 rounded-full bg-lime-400/10 blur-[100px]"
          />
          ...
          <a
            ...
            className="relative mt-8 inline-flex h-12 items-center gap-2 rounded-xl bg-accent-fill px-6 font-semibold text-ink-950 transition-transform hover:scale-[1.02]"
          >
            <GithubIcon size={18} />
            {t("oss.cta")}
          </a>
